...
export const getIjazahList = async (params = {}) => {
  try {
    ...
    return {
      data: [
        { id: 1, nama: "Adi Saputra", nim: "2011080518", prodi: "Teknik Informatika", tahunLulus: 2024, status: "Valid" },
        { id: 2, nama: "Rani Maharani", nim: "2211080518", prodi: "Akuntansi", tahunLulus: 2026, status: "Proses" },
        { id: 3, nama: "Budi Pratama", nim: "1811080518", prodi: "Manajemen Bisnis", tahunLulus: 2022, status: "Valid" },
        { id: 4, nama: "Kayla Kay", nim: "2011080518", prodi: "Ilmu Hukum", tahunLulus: 2024, status: "Reject" },
      ],
      total: 4,
      page: 1,
      totalPages: 1,
...
// Verify ijazah
export const verifyIjazah = async (nim) => {
  try {
    const response = await fetch(`${API_BASE_URL}/verify/${nim}`, {
      method: "POST",
