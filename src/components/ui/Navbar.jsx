...
const roleLabels = {
  ...
  dekan:        { name: "Dekan",                subtitle: "Fakultas" },
  wakil_dekan:  { name: "Wakil Dekan",          subtitle: "Fakultas" },
  tu_fakultas:  { name: "Tata Usaha",           subtitle: "Fakultas" },
...
const Navbar = () => {
  ...
  const currentRole = roleLabels[userRole] || { name: "User", subtitle: "Sistem" };
  ...
  const showNotifIcon = userRole !== "admin";
    ...
    >
      <div className="px-4 md:px-8 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 md:gap-5">
          ...
          >
            {/* ✅ Nama & Role sesuai Figma: "Admin" / "Sistem" */}
