    ...
    <nav className="w-full bg-white shadow-sm px-4 md:px-8 py-3 flex items-center justify-between border-b border-gray-100 relative z-50">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="leading-tight hidden sm:block">
          ...
          <div className="text-[#0D6360] font-bold text-sm">Ibn Khaldun Bogor</div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 md:gap-6">
        ...
        >
          ...
          <div className="text-right leading-tight hidden sm:block">
            <div className="text-[#0B4B48] font-bold text-sm capitalize">
              {user.name}
            </div>
          ...
          <div className="
            ...
            rounded-full 
            border-2 border-[#0B4B48] 
            flex items-center justify-center 
            text-[#0B4B48] 
            bg-gray-50 
            group-hover:bg-[#0B4B48] 
