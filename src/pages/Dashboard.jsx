...
const generateDummyData = () => {
  ...
  for (let i = 1; i <= 6135; i++) {
    ...
    // Custom entries for first 20 records
...
const Icons = {
  ...
  Check: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#16719E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 11 12 14 22 4"></polyline><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"></path></svg>,
  ...
  DropdownArrow: <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 4.5L6 8L9.5 4.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
};
  ...
  return (
    <DashboardLayout>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div onClick={() => navigate("/ijazah-terbit")} className="cursor-pointer transition-transform hover:scale-105">
          <StatCard title="Jumlah Ijazah Terbit" value="5.625" sub="20 Ijazah Terbit Minggu ini" subColor="text-[#27AE60]" icon={Icons.Badge} />
        </div>
        <div onClick={() => navigate("/ijazah-proses")} className="cursor-pointer transition-transform hover:scale-105">
          <StatCard title="Jumlah Ijazah di Proses" value="451" sub="12 di Proses Minggu ini" subColor="text-[#16719E]" icon={Icons.Check} />
        </div>
        <div onClick={() => navigate("/ijazah-reject")} className="cursor-pointer transition-transform hover:scale-105">
          <StatCard title="Jumlah Ijazah di Reject" value="42" sub="2 Data di Reject Minggu ini" subColor="text-[#EF4444]" icon={Icons.Close} />
        </div>
        <div onClick={() => navigate("/ijazah-revoke")} className="cursor-pointer transition-transform hover:scale-105">
          ...
          {totalPages > 1 && (
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="w-8 h-8 flex items-center justify-center text-gray-400 hover:text-black font-bold disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {"<"}
              </button>
